function [optCost, optPath] = lca(A,startNode,terminalNode)
% [optCost, optPath] = lca(A,startNode,terminalNode)
%
% Function template for the execution of the Label Correcting algorithm
% (Book Dynamic Programming and Optimal Control, Bertsekes, page 81).
%
% Input:
